            ...
            <div class="main-body">
                <div class="row">
                    <div class="col-lg-10">
                        <div class="card">
                            <div class="card-body">
                                <form id="myForm" method="POST" action="{{ route('update.brand', $brand->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img src="{{ (!empty($brand->brand_image)) ? asset($brand->brand_image) : asset('admin/assets/images/no_image.jpg') }}" alt="Admin" id="showImage" class="" style="width: 100px; height: 100px">
