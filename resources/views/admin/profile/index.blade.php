                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{ (!empty($adminData->photo)) ? asset('upload/admin/profile/'.$adminData->photo) : asset('admin/assets/images/no_image.jpg') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                    <div class="mt-3">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('admin.profile.update') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img src="{{ (!empty($adminData->photo)) ? asset('upload/admin/profile/'.$adminData->photo) : asset('admin/assets/images/no_image.jpg') }}" alt="Admin" id="showImage" class="" style="width: 100px; height: 100px">
