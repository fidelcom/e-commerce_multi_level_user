...
{{--                </li>--}}
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('all.product.category') }}"><i class="bx bx-right-arrow-alt"></i>All Category</a>
                </li>
                <li> <a href="{{ route('add.product.category') }}"><i class="bx bx-right-arrow-alt"></i>Add Category</a>
                </li>
{{--                <li> <a href="dashboard-analytics.html"><i class="bx bx-right-arrow-alt"></i>Analytics</a>--}}
{{--                </li>--}}
{{--                <li> <a href="dashboard-digital-marketing.html"><i class="bx bx-right-arrow-alt"></i>Digital Marketing</a>--}}
...
{{--                </li>--}}
        ...
        <li>
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">Product Subcategory</div>
            </a>
            <ul>
                <li> <a href="{{ route('all.product.subcategory') }}"><i class="bx bx-right-arrow-alt"></i>All Product Subcategory</a>
                </li>
                <li> <a href="{{ route('add.product.subcategory') }}"><i class="bx bx-right-arrow-alt"></i>Add Product Subcategory</a>
                </li>
            </ul>
        </li>
        <li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('inactive.vendor') }}"><i class="bx bx-right-arrow-alt"></i>Vendors</a>
                </li>
