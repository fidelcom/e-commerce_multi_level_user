                        ...
                        <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading">
                            <div class="d-flex categori-dropdown-inner">
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{ url('product/category/'.$cat->id.'/'.$cat->slug) }}"> <img src="{{ asset( $cat->image ) }}" alt="" />{{ $cat->name }}</a>
                                    </li>
                                    @endforeach
                                </ul>
                                <ul class="end">
                    ...
                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                        <nav>
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('shop') }}">Shop <i class="fi-rs-angle-down"></i></a>
                                    <ul class="sub-menu">
                                        @foreach(\App\Models\Brand::orderBy('name', 'ASC')->get() as $brand)
                                            <li><a href="shop-grid-right.html">{{ $brand->name }}</a></li>
                                        @endforeach
                                    </ul>
                                </li>
{{--                                <li>--}}
...
{{--                                </li>--}}
                                <li class="position-static">
                                    <a href="#">All Product <i class="fi-rs-angle-down"></i></a>
                                    <ul class="mega-menu">
                                        @foreach(\App\Models\ProductCategory::orderBy('name', 'ASC')->get() as $item)
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                                <a class="menu-title" href="{{ url('product/category/'.$item->id.'/'.$item->slug) }}">{{ $item->name }}</a>
                                                <ul>
                                                    @foreach($item->product_subcategory as $sub)
                                                    <li><a href="{{ url('product/subcategory/'.$sub->id.'/'.$sub->slug) }}">{{ $sub->name }}</a></li>
                                                    @endforeach
                                                </ul>
                                            </li>
                                        @endforeach
...
{{--                                    </ul>--}}
{{--                                </li>--}}
                                @foreach(\App\Models\ProductCategory::orderBy('name', 'ASC')->limit(4)->get() as $item)
                                <li>
                                    <a href="{{ url('product/category/'.$item->id.'/'.$item->slug) }}">{{ $item->name }} <i class="fi-rs-angle-down"></i></a>
                                    <ul class="sub-menu">
                                        @foreach($item->product_subcategory as $sub)
                                            <li><a href="{{ url('product/subcategory/'.$sub->id.'/'.$sub->slug) }}">{{ $sub->name }}</a></li>
                                        @endforeach
...
<div class="mobile-header-active mobile-header-wrapper-style">
    <div class="mobile-header-wrapper-inner">
        ...
        <div class="mobile-header-content-area">
            ...
            <div class="site-copyright">Copyright 2022 © Fidelcom. All rights reserved. Powered by Fidelcom.</div>
        </div>
    </div>
</div>
<!--End mobile header-->
