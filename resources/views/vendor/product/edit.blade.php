...
{{--                                        </div>--}}
        ...
        <div class="page-content">
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('vendor.update.product.thumbnail', $product->id) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
        ...
        <div class="page-content">
            <div class="d-flex justify-content-between">
                ...
                <form method="POST" action="{{ route('vendor.add.product.multi.image', $product->id) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-body">
                    <table class="table mb-0 table-striped">
                        ...
                        <tbody>
                        <form method="POST" action="{{ route('vendor.update.product.multi.image', $product->id) }}" enctype="multipart/form-data">
                            @csrf
                            @foreach($product->multiImage as $key => $image)
                                <tr>
                                    ...
                                    <td>
                                        <button type="submit" class="btn btn-primary">Update Image</button>
                                        <a href="{{ route('vendor.delete.product.multi.image', $image->id) }}" id="delete" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </form>
    ...
    <script>
        $(document).ready(function (){
            $('select[name="product_category_id"]').on('change', function (){
                ...
                {
                    $.ajax({
                        url: "{{ url('/vendor/product/subcategory/show') }}/"+product_category_id,
                        type: "GET",
                        dataType: "json",
