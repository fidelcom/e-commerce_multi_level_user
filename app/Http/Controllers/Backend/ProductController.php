...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.product.create', compact('category', 'brand', 'subcategory', 'vendor'));
    }
...
//        multiple image upload
    ...
    public function edit(string $id)
    {
        ...
        return view('backend.product.edit', compact('category', 'brand', 'subcategory', 'vendor', 'product'));
